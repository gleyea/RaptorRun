...
*                                                                          *
\**************************************************************************/
void INPUT2::set_key_down(dword key)
{
  tmp_keys [key] = true;
  tmp_pulse[key] = true;
}
...
*                                                                          *
\**************************************************************************/
void INPUT2::set_key_up(dword key)
{
  tmp_keys[key] = false;
}
...
*                                                                          *
\**************************************************************************/
void INPUT2::set_mouse_left_down()
{
  LBmouse_tmp = true;
}
...
*                                                                          *
\**************************************************************************/
void INPUT2::set_mouse_right_down()
{
  RBmouse_tmp = true;
}
...
*                                                                          *
\**************************************************************************/
void INPUT2::set_mouse_right_up()
{
  RBmouse_tmp = false;
}
...
*                                                                          *
\**************************************************************************/
void INPUT2::set_mouse_middle_down()
{
  MBmouse_tmp = true;
}
...
*                                                                          *
\**************************************************************************/
void INPUT2::set_mouse_middle_up()
{
  MBmouse_tmp = false;
}
...
*                                                                          *
\**************************************************************************/
void INPUT2::set_mouse_pos(dword x, dword y)
{
...
*                                                                          *
\**************************************************************************/
void INPUT2::get_mouse_movement()
{
